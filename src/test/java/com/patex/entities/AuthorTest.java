...
public class AuthorTest {
    ...
    public void getSequences() {
        ...
        MatcherAssert.assertThat(author.getSequences().collect(Collectors.toList()), is((empty())));
        ...
        MatcherAssert.assertThat(author.getSequences().collect(Collectors.toList()), hasSize(1));
        book1.getSequences().add(new BookSequence(0, sequence1));
        MatcherAssert.assertThat(author.getSequences().collect(Collectors.toList()), hasSize(1));
        ...
        MatcherAssert.assertThat(author.getSequences().collect(Collectors.toList()), hasSize(2));
