...
public class Fb2Creator {
    ...
    public Fb2Creator setLang(String lang) {
        fbook.getDescription().getTitleInfo().setLang(lang);
        return this;
    }


    public Fb2Creator setSrcLang(String lang) {
        fbook.getDescription().getTitleInfo().setSrcLang(lang);
        return this;
    }
