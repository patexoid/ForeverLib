...
public class TableType {
    ...
    public static class Tr {
        ...
        @XmlElementRefs({
            @XmlElementRef(name = "th", namespace = "http://www.gribuser.ru/xml/fictionbook/2.0", type = JAXBElement.class),
            @XmlElementRef(name = "td", namespace = "http://www.gribuser.ru/xml/fictionbook/2.0", type = JAXBElement.class)
        })
